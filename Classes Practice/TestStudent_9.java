...
class Student
{
	...
	public void displayInfo()
	{
		...
		double average = getAverage (getMark1(), getMark2());
		int finalMark = getFinalMark (getMark1(), getMark2());
		...
		System.out.printf ("Subject 2: %s, mark2 = %.1f%n", getSubject2(), getMark2());
